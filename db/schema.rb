...
ActiveRecord::Schema[7.2].define(version: 2026_04_24_000001) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["specialty_id"], name: "index_comments_on_specialty_id"
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["specialty_id"], name: "index_favorites_on_specialty_id"
    t.index ["user_id", "specialty_id"], name: "index_favorites_on_user_id_and_specialty_id", unique: true
  ...
  create_table "specialty_tags", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["specialty_id", "tag_id"], name: "index_specialty_tags_on_specialty_id_and_tag_id", unique: true
    t.index ["specialty_id"], name: "index_specialty_tags_on_specialty_id"
    t.index ["tag_id"], name: "index_specialty_tags_on_tag_id"
  end
